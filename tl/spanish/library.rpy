...
translate spanish strings:
    ...
    old "WARHEAD AMMO"
    new "MUNICIÓN DE CABEZAS DE GUERRA"

    # game/library.rpy:2646
    old "Purchase warheads to allow the Sunrider to fire powerful rockets at the enemy. A rocket deals {} damage, but can be shot down by enemy flak. The Sunrider can carry a maximum of 2 at a time."
    new "Compra cabezas de guerra para permitir al Sunrider disparar poderosos proyectiles al enemigo. Un proyectil provoca {} daño, pero puede ser derribado por el fuego antiaéreo enemigo. El Sunrider puede cargar un máximo de 2 al mismo tiempo."

    # game/library.rpy:2657
    ...
    new "El Black Jack fue diseñado para ser compatible con motores de grado militar de alta-potencia, pero esos no son fáciles de encontrar. Gracias a tus conexiones con la Unión Minera, esto ya no necesita seguir siendo así."

    # game/library.rpy:2767
    old "GRAVITINO GENERATOR"
    new "GENERADOR DE GRAVITINO"

    # game/library.rpy:2769
    ...
    old "SUNRIDER VANGUARD UPGRADE"
    new "MEJORA DEL VANGUARD DEL SUNRIDER"
