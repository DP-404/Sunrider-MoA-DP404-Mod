...
init python:
    ...
    #Planet("ASTRAL{p}EXPANSE", "warpto_astralexpanse", 1250, 540, "warpto_astralexpanse")
    #Planet("AVANZADA{p}DEL PACT", "warpto_pactstation", 1420, 480, "warpto_pactstation1")
    #Planet("VERSTA", "warpto_versta", 1490, 725, "warpto_versta")
    #Planet("NOMODORN", "warpto_nomodorn", 1630, 590, "warpto_nomodorn")
    #Planet("RYUVIA{p}PRIME", "warpto_ryuvia", 1410, 740, "warpto_ryuvia")
