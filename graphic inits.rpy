...
image cg_asagashower1:
    "CG/asagashower1.jpg"
image cg_asagashower1_censored:
    "CG/asagashower1_censored.jpg"
image cg_asagashower2:
    "CG/asagashower2.jpg"
image cg_asagashower2_censored:
    "CG/asagashower2_censored.jpg"
...
# UNUSED
image cg_legionfleetagain_fire:
    "CG/legionfleetagain_fire.jpg"
...
image shieldsvanguard1 = Text(_("This is my command!"), size=75, font="Font/GOTHIC.TTF", xalign=0.5, yalign=0.85)
image shieldsvanguard2 = Text(_("Prepare to fire the Vanguard Cannon!"), size=75, font="Font/GOTHIC.TTF", xalign=0.5, yalign=0.85)
image shieldsvanguard3 = Text(_("Vanguards..."), size=75, font="Font/GOTHIC.TTF", xalign=0.5, yalign=0.85)
image shieldsvanguard4 = Text(_("FIRE!"), size=75, font="Font/GOTHIC.TTF", xalign=0.5, yalign=0.85)

image credits1 = Text(_("Project Director {p}         Sam Yang (Samu-kun)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits2 = Text(_("Writer{p}         Sam Yang (Samu-kun)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits3 = Text(_("Lead Character Artist{p}         Ashton Wilson (Melonbunny)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits5 = Text(_("Additional Character Design{p}         Adrian Ferrer (Sixten)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits6 = Text(_("Mechanical Design{p}         Sam Yang (Samu-kun)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits7 = Text(_("3D Textures{p}         CGTextures"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits8 = Text(_("Background Art{p}         Sam Yang (Samu-kun)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits9 = Text(_("Lead Programmer{p}         Paul Schovers (Vaendryl)"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits10 = Text(_("Renpy Engine Programmer{p}         Tom Rothamel"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits11 = Text(_("Additional Programming{p}         Tom Rothamel, Sam Yang, Endershadow"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits11c = Text(_("Github Contributors{p}         Tom Rothamel, Quickman, Renari, KingRaptor, {p}BlueOrange, DoumanAsh, LongKnight"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits11b = Text(_("Hex Mod{p}         azureflare"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits12 = Text(_("Cast"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits13 = Text(_("Ava Crescentia:  Amber Lee Connors"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits14 = Text(_("Asaga di Ryuvia:  Kira Buckland"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits15 = Text(_("Chigara Ashada:  Mary Morgan"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16 = Text(_("Cosette Cosmos:  Jill Harris"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16b = Text(_("Icari Isidolde:  Aimee Smith"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16c = Text(_("Claude Trillo:  Sydney P"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16d = Text(_("Sola di Ryuvia:  Tina Kim"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16e = Text(_("Kryska Stares:  Cayla Martin"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16f = Text(_("Alliance Cruiser Captain:  Mike Salyer"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16g = Text(_("Union Frigate Captain:  Jonathan Cooke"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits16h = Text(_("Alliance Battleship Captain:  Patrick Seymour"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits17 = Text(_("Captain Kayto Shields:  Jonathan Cooke"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
image credits18 = Text(_("Voice Director{p}         Mike Salyer"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits19 = Text(_("Sound Effects{p}         Steve Green"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits20 = Text(_("Voice Clean Up{p}         Steve Green"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits21 = Text(_("Soundtrack{p}         Arnaud Conde, Marc Teichert, Epic Soul Factory{p}Celestrial Aeon Project, Eternal Dream, SAMFREE Music, Amacha Music"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits22 = Text(_("OP Song{p}         |Sora no Senritsu|{p}vocals: lily-an{p}instruments: Keita Takanashi{p}Iced Blade"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits23 = Text(_("ED Song{p}         |Firn -The Pale Sun-|{p}vocals: lily-an, Maya{p}instruments: Keita Takanashi{p}Iced Blade"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits24 = Text(_("Additional Sound Effects{p}         fonogeno, junggle, sandyrb, sarge4267, ryansnook, klerrp,{p}robinhood76, nengisuls, mediapaja2009, shawnyboy,{p}zimbot, lloydevans09, goup, omar-alvarado, roper1911,{p}NEO_Soun, BlackCow, Ivan-8042, Diode111, cgeffex,{p}qudodup, unfa, zeuss, kiddpark, isaac200000, tommccann"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
image credits26 = Text(_("CC Love in Space, 2013-14"), size=30, font="Font/GOTHIC.TTF", text_align=0.5)

image credits25 = Text(_("Many thanks to those who entered our Fan Fiction contest!{p}The winners are:{p}1: Marx-93 - Home{p}2: Whalecow - Unknown Pilot-kun: Unknown Soldier{p}3: Drath - The Fall of Senna{p}4: Light Mage - Pirate Logs{p}5: Radclive - Lifa and Times of Sola vi Ryuvia"), size=30, font="Font/GOTHIC.TTF", text_align=0)

image credits27 = Text(_("We thank the following Kickstarter backers..."), size=30, font="Font/GOTHIC.TTF", text_align=0.5)
...
###############################TRANSITIONS
    ...
    $ battlewipe = ImageDissolve("Menu/transistion_battle.jpg", 2, reverse=False)
    ...
    $ wipeupfast = ImageDissolve("Transitions/up_to_down.jpg", 0.3, reverse=True)
...
########################
    ...
    #image miss = Text('Miss', size=35)
    #image miss_es = Text('Fallo', size=35)
