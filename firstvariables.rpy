...
init python:
    class AllVariables(store.object):
        def __init__(self):
            ...
            self.chat_asaga = False
            self.chat_chigara = False
            self.chat_ava = False
            self.chat_icarikryska = False
            self.chat_sola = False
            self.chat_claude = False
