...
- Translated AI.
- Enhanced original script with restoring changed music after a ship side event.

### Bugs and Other fixes

- Enhanced preferences hotspots.
- Enhanced shipmap and galaxy map images to better resemble the original ones.
- Enhanced weapon button images.
- Enhanced phase images.
