...
label atkanim_sunrider_vanguard:
    ...
    if renpy.music.get_playing() != "music/Sora_no_Senritsu.ogg":
        play music "music/March_of_Immortals.ogg" noloop fadeout 1.5
    play sound "sound/Sword Shing 2.ogg"
    play kayvoice "sound/Voice/Shields/Cpt Shields 1.ogg"

    show shieldsvanguard1
    ...
    hide shieldsvanguard1
    show shieldsvanguard2

    show captain_order 1 behind shieldsvanguard2:
        xpos 1.0 alpha 0 
        ease 0.5 xpos 0.5 alpha 1

    #hide shieldsvanguard2
    #show shieldsvanguard2
    ...
    hide shieldsvanguard2
    show shieldsvanguard3
    pause 0.75
    hide shieldsvanguard3
    show shieldsvanguard4

    #pause 0.25 #It was originally 1.0
